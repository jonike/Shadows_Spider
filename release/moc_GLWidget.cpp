...
QT_MOC_LITERAL(4, 35, 8) // "mimeData"
    ...
    "GLWidget\0changed\0\0const QMimeData*\0"
    "mimeData"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GLWidget::*_t)(const QMimeData * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLWidget::changed)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void GLWidget::changed(const QMimeData * _t1)
{
